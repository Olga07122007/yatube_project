# Generated by Django 2.2.16 on 2022-11-14 09:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='group',
            name='slug',
            field=models.SlugField(unique=True, verbose_name='Url-адрес группы'),
        ),
        migrations.AlterField(
            model_name='group',
            name='title',
        ...
        migrations.AlterField(
            model_name='post',
            name='author',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to=settings.AUTH_USER_MODEL, verbose_name='Автор заметки'),
        ),
        migrations.AlterField(
            model_name='post',
            name='group',
